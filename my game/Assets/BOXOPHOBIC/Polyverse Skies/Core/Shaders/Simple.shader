		...
		Pass
		{
			...
			CGPROGRAM
				...
				v2f vert ( appdata v )
				{
					...
					o.ase_texcoord.xyz = vertexToFrag1216;
					...
					o.ase_texcoord.w = vertexToFrag856;
					...
					o.ase_texcoord1.xyz = vertexToFrag763;
					...
					o.ase_texcoord2.xy = vertexToFrag993;
					...
					o.ase_texcoord1.w = vertexToFrag997;
					...
					o.ase_texcoord3.xyz = vertexToFrag1133;
				...
				half4 frag( v2f IN  ) : SV_Target
				{
					...
					float3 vertexToFrag1216 = IN.ase_texcoord.xyz;
					half3 VertexPos1217 = vertexToFrag1216;
					float3 lerpResult180 = lerp( _GroundColor.rgb , _SkyColor.rgb , step( 0.0 , VertexPos1217.y ));
					...
					float3 lerpResult288 = lerp( _EquatorColor.rgb , lerpResult180 , pow( saferPower470 , ( 1.0 - _EquatorSmoothness ) ));
					half3 SKY218 = lerpResult288;
					half3 BACKGROUND1202 = ( texCUBE( _BackgroundCubemap, VertexPos1217 ).rgb * _BackgroundExposure );
					#if defined( _BACKGROUNDMODE_COLORS )
					float3 staticSwitch1207 = SKY218;
					#elif defined( _BACKGROUNDMODE_CUBEMAP )
					float3 staticSwitch1207 = BACKGROUND1202;
					#elif defined( _BACKGROUNDMODE_COMBINED )
					float3 staticSwitch1207 = ( SKY218 * BACKGROUND1202 );
					#else
					float3 staticSwitch1207 = SKY218;
					#endif
					half3 STARS1263 = ( _StarsIntensity * _StarsColor.rgb );
					float vertexToFrag856 = IN.ase_texcoord.w;
					float3 vertexToFrag763 = IN.ase_texcoord1.xyz;
					float3 break1223 = VertexPos1217;
					float lerpResult268 = lerp( 1.0 , ( unity_OrthoParams.y / unity_OrthoParams.x ) , unity_OrthoParams.w);
					half CAMERA_MODE300 = lerpResult268;
					float temp_output_673_0 = ( break1223.y * CAMERA_MODE300 );
					...
					half STARS_MASK630 = ( floor( ( vertexToFrag856 * ( texCUBE( _StarsCubemap, vertexToFrag763 ).g + _StarsSize ) ) ) * lerpResult1234 );
					float3 lerpResult1264 = lerp( staticSwitch1207 , STARS1263 , STARS_MASK630);
					#ifdef _ENABLESTARS_ON
					float3 staticSwitch1170 = lerpResult1264;
					#else
					float3 staticSwitch1170 = staticSwitch1207;
					#endif
					float2 vertexToFrag993 = IN.ase_texcoord2.xy;
					float4 tex2DNode995 = tex2D( _SunTexture, vertexToFrag993 );
					half3 SUN1004 = ( tex2DNode995.r * _SunColor.rgb * max( _SunIntensity , 1.0 ) );
					float vertexToFrag997 = IN.ase_texcoord1.w;
					half SUN_MASK1003 = ( tex2DNode995.a * saturate( _SunIntensity ) * vertexToFrag997 );
					float3 lerpResult176 = lerp( staticSwitch1170 , SUN1004 , SUN_MASK1003);
					#ifdef _ENABLESUN_ON
					float3 staticSwitch1167 = lerpResult176;
					#else
					float3 staticSwitch1167 = staticSwitch1170;
					#endif
					float3 vertexToFrag1133 = IN.ase_texcoord3.xyz;
					...
					float3 lerpResult227 = lerp( staticSwitch1167 , CLOUDS222 , CLOUDS_MASK223);
					#ifdef _ENABLECLOUDS_ON
					float3 staticSwitch1162 = lerpResult227;
					#else
					float3 staticSwitch1162 = staticSwitch1167;
					#endif
					...
					float4 lerpResult317 = lerp( unity_FogColor , float4( staticSwitch1162 , 0.0 ) , FOG_MASK359);
					#ifdef _ENABLEBUILTINFOG_ON
					float4 staticSwitch921 = lerpResult317;
					#else
					float4 staticSwitch921 = float4( staticSwitch1162 , 0.0 );
					#endif
...
/*ASEBEGIN
Version=19901
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1236;-896,-4592;Inherit;False;Property;_SkyboxOffset;Skybox Offset;40;0;Create;True;0;0;0;False;0;False;0;0.21;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1211;-896,-4320;Inherit;False;Property;_SkyboxRotation;Skybox Rotation;41;0;Create;True;0;0;0;False;0;False;0;0.115;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1212;-896,-4480;Inherit;False;Property;_SkyboxRotationAxis;Skybox Rotation Axis;42;0;Create;True;0;0;0;False;1;StyledVector(18);False;0,1,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1259;-1408,-864;Half;False;Property;_SunDirection;Sun Direction;25;0;Create;True;0;0;0;False;1;StyledVector(18);False;0,0,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1257;-1408,-1024;Half;False;Global;PolyverseSunDir;PolyverseSunDir;38;0;Create;True;0;0;0;False;0;False;0,0,0;-0.3830222,-0.6427875,0.6634141;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1260;-1408,-704;Half;False;Property;_SunDirectionMode;Sun Direction;24;1;[Enum];Create;False;0;2;Global From Script;0;Local From Material;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;831;1600,-1600;Half;False;Property;_StarsHeightMask;Stars Height Mask;16;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;975;0,-768;Half;False;Property;_SunSize;Sun Size;22;0;Create;True;0;0;0;False;0;False;0.5;0.5;0.1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;241;-896,192;Half;False;Property;_CloudsHeight;Clouds Height;30;0;Create;True;0;0;0;False;0;False;0;0;-0.5;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;180;1024,-2752;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1231;3200,-1376;Inherit;False;1230;Starts_Bottom_Mask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1201;-256,-3584;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;288;1280,-2944;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;876;2944,-1472;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1232;3200,-1312;Half;False;Property;_StarsBottomMask;Stars Bottom Mask;17;0;Create;True;0;0;0;False;1;StyledToggle;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1233;3440,-1376;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1202;256,-3584;Half;False;BACKGROUND;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;218;1664,-2944;Half;False;SKY;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1168;1568,-976;Float;False;Property;_ENABLESUN_ON;Enable Sun;19;0;Create;False;0;0;0;False;0;False;0;0;0;False;;Toggle;2;Key0;Key1;Reference;1167;False;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FloorOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;886;3200,-1472;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1261;3456,-1664;Half;False;Property;_StarsColor;Stars Color;14;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;629;3456,-1792;Half;False;Property;_StarsIntensity;Stars Intensity;15;0;Create;True;0;0;0;False;0;False;2;2.71;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1234;3584,-1376;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1204;-896,-6576;Inherit;False;1202;BACKGROUND;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;996;2176,-576;Half;False;Property;_SunIntensity;Sun Intensity;23;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1205;-896,-6656;Inherit;False;218;SKY;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;882;3840,-1472;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1262;3840,-1792;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1169;3392,-640;Float;False;Property;_ENABLESUN_ON;Enable Sun;19;0;Create;False;0;0;0;False;0;False;0;0;0;False;;Toggle;2;Key0;Key1;Reference;1167;False;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1206;-640,-6528;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1163;384,80;Float;False;Property;_ENABLECLOUDS_ON;Enable Clouds;27;0;Create;False;0;0;0;False;0;False;0;0;0;False;;Toggle;2;Key0;Key1;Reference;1162;False;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;998;2176,-768;Half;False;Property;_SunColor;Sun Color;21;0;Create;True;0;0;0;False;1;Space(10);False;1,1,1,1;1,1,1,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;995;2176,-1024;Inherit;True;Property;_SunTexture;Sun Texture;20;1;[NoScaleOffset];Create;True;0;0;0;False;2;Space(10);StyledTextureSingleLine;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;630;4032,-1472;Half;False;STARS_MASK;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1263;4032,-1792;Half;False;STARS;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.VertexToFragmentNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;997;3632,-640;Inherit;False;False;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;325;-896,1216;Half;False;Property;_FogSmoothness;Fog Smoothness;37;0;Create;True;0;0;0;False;0;False;0;0;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1002;2688,-1024;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;313;-896,1088;Half;False;Property;_FogHeight;Fog Height;36;0;Create;True;0;0;0;False;1;Space(10);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;632;-384,-6336;Inherit;False;630;STARS_MASK;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1265;-384,-6432;Inherit;False;1263;STARS;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;41;1024,0;Inherit;True;Property;_CloudsCubemap;Clouds Cubemap;28;1;[NoScaleOffset];Create;True;0;0;0;False;2;Space(10);StyledTextureSingleLine;False;-1;None;5bf545dec997743419de1df4195b3a0d;True;0;False;black;LockedToCube;False;Object;-1;Auto;Cube;8;0;SAMPLERCUBE;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1004;4352,-1024;Half;False;SUN;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1229;1024,256;Half;False;Property;_CloudsIntensity;Clouds Intensity;29;0;Create;True;0;0;0;False;1;Space(10);False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;232;1792,0;Half;False;Property;_CloudsShadowColor;Clouds Shadow Color;32;0;Create;True;0;0;0;False;0;False;0.4980392,0.7450981,1,1;1,0.1853116,0,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;261;1792,224;Half;False;Property;_CloudsLightColor;Clouds Light Color;31;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1264;0,-6528;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;101;2176,0;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1112;256,-6432;Inherit;False;1004;SUN;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;222;2560,0;Half;False;CLOUDS;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;679;128,1216;Half;False;Property;_FogFill;Fog Fill;38;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;176;576,-6528;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;228;768,-6432;Inherit;False;222;CLOUDS;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1167;768,-6656;Float;False;Property;_EnableSun;Enable Sun;19;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;227;1088,-6528;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1218;256,-7296;Half;False;Property;_SkyboxCat;[ Skybox Cat ];39;0;Create;True;0;0;0;True;1;StyledCategory(Skybox Settings);False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1192;96,-7296;Half;False;Property;_FogCat;[ Fog Cat ];33;0;Create;True;0;0;0;True;1;StyledCategory(Fog Settings);False;1;1;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1209;-896,1344;Inherit;False;Property;_EnableFogMessage;EnableFogMessage;35;0;Create;True;0;0;0;True;1;StyledMessage(Info, The fog color is controlled by the fog color set in the Lighting panel., _EnableBuiltinFog, 1, 10, 0);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1190;-240,-7296;Half;False;Property;_SunCat;[ Sun Cat ];18;0;Create;True;0;0;0;True;1;StyledCategory(Sun Settings);False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;921;1920,-6656;Float;False;Property;_EnableBuiltinFog;Enable Fog;34;0;Create;False;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1191;-80,-7296;Half;False;Property;_CloudsCat;[ Clouds Cat ];26;0;Create;True;0;0;0;True;1;StyledCategory(Clouds Settings);False;1;1;1;1;0;1;FLOAT;0
...
WireConnection;882;1;1234;0
WireConnection;1262;0;629;0
WireConnection;1262;1;1261;5
...
ASEEND*/
//CHKSM=29BFE9647FA2F241F5AF8E56C8C5FFAD8DFDC017