...
[CustomEditor(typeof(SkillPrepPanel))]
public class SkillPrepPanelEditor : Editor
{
    void OnEnable()
    {
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (slotCount == 0)
        {
            EditorGUILayout.HelpBox("尚未 Configure（SkillPrepPanel 未 Awake）。", MessageType.Warning);
            return;
        }
